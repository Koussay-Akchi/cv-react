...
const resources = {
  en: {
    translation: {
      ...
      experienceContentAlliance:
        'Developed a microservice and API for managing electronic purchase vouchers for SNDP customers using C#, ASP.NET, Java, and PostgreSQL.',
      ...
      cluverseTitle: 'Cluverse - Cloud-Native AI Club Management Platform',
      cluverseDescription:
        'Enterprise-grade, microservice SaaS platform modernizing student club operations with private cloud infrastructure, self-healing orchestration, and applied AI intelligence. Built on OpenStack, Kubernetes, Spring Boot 3.4, and FastAPI with autonomous predictive monitoring (Meta Prophet), live AI speech interviews (Whisper v2 + Groq Llama 3.1), and real-time observability.',
      cluverseGalleryGlobal: 'Global Cloud-Native Microservices Architecture',
      cluverseGalleryPhysical: 'Physical Infrastructure & Multi-Node Cluster Topology',
      cluverseGalleryRepos: 'Microservices Repository Ecosystem',
      cluverseGalleryOpenstack: 'OpenStack Heat Orchestration & Private Cloud Services',
      cluverseGalleryOverview: 'Cluverse Platform Overview & Executive Dashboard',
      cluverseGalleryInterview: 'Live AI Speech Interview & Bias-Free Scoring Engine',
      cluverseGallerySkills: 'Member Competency Tracking & Skills Profile',
      cluverseGalleryCV: 'Automated CV Analysis & Candidate Skill Extraction',
      cluverseGalleryElectionManagement: 'Cryptographic Weighted Voting & Election Management',
      cluverseGalleryRecruitment: 'Club Recruitment Campaigns & Candidate Funnel',
      cluverseGalleryRealtimeElections: 'Real-Time Democratic Voting Workflows',
      cluverseGalleryElectionResults: 'Election Auditing & Live Results Visualization',
      cluverseGalleryBudgetOverviews: 'Multi-Club Budgeting, Ledgers & Expense Analytics',
      cluverseGalleryFinancialAI: 'RAG Financial AI Assistant & Treasury Forecasting',
      cluverseGallerySponsorship: 'Corporate Sponsorship CRM & Dynamic Contract Pipeline',
      cluverseGalleryStripe: 'Stripe Payment Gateway & AI Fraud Detection',
      cluverseGalleryLogistics: 'Logistics Fleet Tracking, Fuel Logs & Maintenance',
      cluverseGalleryTelemetry: 'Prometheus, Grafana & Meta Prophet AI Anomaly Detection',
      screens: 'Screenshots',
      showcase: 'Showcase',
      viewShowcase: 'View Showcase & Gallery',
  ...
  fr: {
    translation: {
      ...
      'June 2023 - July 2023': 'Juin 2023 - Juillet 2023',
      ...
      cluverseTitle: 'Cluverse - Plateforme SaaS Cloud-Native & IA pour la gestion d’organisations',
      cluverseDescription:
        "Plateforme SaaS microservices d'envergure modernisant les opérations des clubs étudiants grâce à une infrastructure cloud privé, une orchestration résiliente et des modules d'IA appliqués. Conçue sur OpenStack, Kubernetes, Spring Boot 3.4 et FastAPI avec surveillance prédictive autonome (Meta Prophet), entretiens vocaux assistés par IA (Whisper v2 + Groq Llama 3.1) et observabilité en temps réel.",
      cluverseGalleryGlobal: 'Architecture globale microservices cloud-native',
      cluverseGalleryPhysical: 'Infrastructure physique et topologie du cluster multi-nœuds',
      cluverseGalleryRepos: 'Écosystème de dépôts des microservices',
      cluverseGalleryOpenstack: 'Orchestration OpenStack Heat & services de cloud privé',
      cluverseGalleryOverview: 'Vue d’ensemble et tableau de bord principal de Cluverse',
      cluverseGalleryInterview: 'Entretien vocal IA en direct & évaluation sans biais humain',
      cluverseGallerySkills: 'Profils de compétences et suivi des membres',
      cluverseGalleryCV: 'Analyse automatique de CV et extraction de compétences',
      cluverseGalleryElectionManagement: 'Gestion automatisée des scrutins & vote pondéré cryptographique',
      cluverseGalleryRecruitment: 'Campagnes de recrutement et entonnoir de candidatures',
      cluverseGalleryRealtimeElections: 'Gestion des élections et votes en temps réel',
      cluverseGalleryElectionResults: 'Résultats des élections et audit en direct',
      cluverseGalleryBudgetOverviews: 'Suivi budgétaire, grands livres et analyse financière',
      cluverseGalleryFinancialAI: 'Assistant financier IA (RAG) et prévision de trésorerie',
      cluverseGallerySponsorship: 'Pipeline de sponsoring CRM et génération dynamique de contrats',
      cluverseGalleryStripe: 'Paiements en ligne Stripe & détection IA de transactions suspectes',
      cluverseGalleryLogistics: 'Gestion de flotte logistique, consommation et alertes',
      cluverseGalleryTelemetry: 'Observabilité Prometheus, Grafana & détection d’anomalies Meta Prophet',
      screens: 'Captures',
      showcase: 'Vitrine',
      viewShowcase: 'Voir la galerie & démonstration',
