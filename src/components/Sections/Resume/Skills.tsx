  ...
  return (
    <div className="flex flex-col">
      <span className="mb-2 ml-2 flex gap-1 text-sm font-medium">
        {t(name)}
        {image && (
          <Image alt={name} className="h-5 w-5 object-contain" height={20} loading="lazy" src={image} width={20} />
        )}
        {image2 && (
          <Image alt={name} className="h-5 w-5 object-contain" height={20} loading="lazy" src={image2} width={20} />
        )}
      </span>
